...
class _ClientAPI(QObject):
    ...
    def reload_client(self):
        ...
        if logged_api_url and logged_api_url in [anaconda_api_url, enterprise_4_repo_api_url]:
            client = self._load_binstar_client(logged_api_url)
        elif logged_api_url and logged_api_url == team_edition_api_url:
            client = self._load_team_edition_client(logged_api_url)
        else:
            client = self._load_binstar_client(anaconda_api_url)
    ...
    def _load_team_edition_client(self, api_url):
        ...
        """
        self._anaconda_client_api = TeamEditionAPI(api_url, self.config)
        return self._anaconda_client_api
